...
using EducationMicroService.Application.BackgroundServices;
...
namespace EducationMicroService.Application
{
    public static class ApplicationServicesRegistration
    {
        public static IServiceCollection ConfigureApplicationServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddValidatorsFromAssemblyContaining<CreateEducationDtoValidator>(ServiceLifetime.Scoped);
            ...
            services.AddHostedService<RedisFeedEducationBackgroundService>();
